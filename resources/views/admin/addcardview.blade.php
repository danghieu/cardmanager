		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel ">
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/addcardview') }}">
						<div class="form-group">
							<label class="col-md-4 control-label">Số Thẻ:</label>
							<div class="col-md-6">
								<input type="card" class="form-control" name="card" placeholder="Ví dụ: 6A DU T5 F6 G9" value="{{ old('card') }}">
							</div>
						</div>
